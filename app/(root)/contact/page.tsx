  ...
  return (
    <main className="bg-secondary lg:py-16 sm:p-8 md:p-10 px-4 py-6">
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <Card className="w-full max-w-4xl flex flex-col-reverse lg:flex-row gap-10 rounded-xl p-8">
          <div className="flex-1">
            <ContactForm />
          </div>
          <div className="w-full flex-1 flex flex-col space-y-4 lg:mt-8">
            <div className="w-full h-auto bg-primary-foreground text-white rounded-xl px-8 py-4">
            ...
            <div className="w-full h-auto bg-primary-foreground text-white rounded-xl px-8 py-4">
              ...
              <div className="flex items-start gap-3 mt-2 ml-6">
